        ...
        <div className="grid md:grid-cols-4 gap-8 py-12">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex space-x-3 mb-4">
              <a
                href="#"
                className="w-9 h-9 bg-zinc-900/40 rounded-lg border border-zinc-800/50 flex items-center justify-center hover:bg-zinc-800/40 hover:border-zinc-700/50 transition-colors group"
              >
